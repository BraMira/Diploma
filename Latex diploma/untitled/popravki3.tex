...
\caption{Numerični zaklad matrike in izhodišče, kjer naš algoritem ne deluje, čeprav bi moral.}
\label{fig:p64}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
