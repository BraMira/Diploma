...
Za prvi primer vzamimo naključno generirano $10\times 10$ matriko $A$ in $\mu = 1,0419$, ki je znotraj numeričnega zaklada, Slika \ref{fig:p1}.
$$\verb+A = randn(10)+$$

\begin{figure}[hbt]
\centering
\includegraphics[scale=0.5]{RR1.jpg}
\caption{Numerični zaklad premaknjene matrike A in z rdečo zvezdico označeno izhodišče}
\label{fig:p1}
\end{figure}
...
Naj bo $A$ naključno generirana realna $10\times 10$ matrika in $\mu = -1,4575 + 0,1514 \imath$ kompleksno število iz numeričnega zaklada, Slika \ref{fig:p3}.

\begin{figure}[hbt]
\centering
\includegraphics[scale=0.5]{RC1.jpg}
\caption{Numerični zaklad premaknjene matrike A in z rdečo zvezdico označeno izhodišče}
\label{fig:p3}
\end{figure}
...
Za drugi primer vzamemo naključno generirano $20\times 20$ matriko A in $\mu = 1 + \imath$, Slika \ref{fig:p4}.
\begin{figure}[hbt]
\centering
\includegraphics[scale=0.5]{RC2.jpg}
\caption{Numerični zaklad premaknjene matrike A in z rdečo zvezdico označeno izhodišče}
\label{fig:p4}
\end{figure}
...
\hline
\end{tabular}
\caption{A realen, $\mu$ kompleksen in rešitev najdemo v 2 koraku.}
\label{t4}
\end{table}

Za tretji primer vzamemo naključno generirano $20\times 20$ matriko A in $\mu = 2 + 2\imath$, Slika \ref{fig:p5}.
\begin{figure}[hbt]
\centering
\includegraphics[scale=0.5]{RC3.jpg}
\caption{Numerični zaklad premaknjene matrike A in z rdečo zvezdico označeno izhodišče}
\label{fig:p5}
\end{figure}
...
\hline
\end{tabular}
\caption{A realen, $\mu$ kompleksen in rešitev najdemo v 3 koraku.}
\label{t5}
\end{table}
