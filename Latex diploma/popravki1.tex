...
%POMEMBNA LEMA
\begin{lema}\label{komp}\cite{meurant},\cite{meurant}
...
Za vsak algoritem bomo preverili v kolikšnem času je našel (ali ni našel) rešitev, koliko korakov je potreboval:
\begin{align*}
Št. korakov & \\
...
\geslo{eigenanalysis}{izračuna lastnih vrednosti in vektorjev}
...
\geslo{skew-Hermitian}{poševno hermitska}
