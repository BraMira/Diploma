...
\begin{primer}
Poglejmo si enostaven zgled za matriko $3\times 3$ z lastnimi vrednostmi $\lambda_1=-1, \lambda_2=1$ in $\lambda_3=2$. Matrika lastnih vektorjev $X$ je enaka identiteti $I$.\\
...
V tem poglavju bomo na kratko opisali naš algoritem, ki je povzet po algoritmu poglavja \ref{Meurant 2} iz \cite{meurant}, vendar pa ni identičen, in ga primerjali z algoritmoma Cardna iz \cite{carden_alg} in CPU iz \cite{trije_alg} na različnih primerih problema iskanja izotropnih vektorjev. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
